...
TARGET="/gpfs1/data/compoundx/yumeng/paper2/pypsa_output/warming2_s0_weather_year_2015_clip/networks/base_s_128_elec_.nc"
snakemake $TARGET \
    --configfile /home/mengyu/projects/pypsa-eur/config/config.default.yaml \
    --configfile /home/mengyu/projects/pypsa-eur/config/my_config3_1.yaml \
    --cores 32 \
    --keep-going \
    --rerun-incomplete \
